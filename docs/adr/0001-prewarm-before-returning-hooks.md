...
Consequences: CLI-open delay is now bounded by the slowest enabled server (≤ 60s), not ~instant. Users with no MCP servers see no delay. `preWarmMs: 0` fire-and-forget mode was removed.
